...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: This found that the Enqueue method was inserting at Index 0 rather that appending
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: This found there was no condition to evaluate when turns where 0
    ...
    // Defect(s) Found: This found there was no condition to evaluate when turns where less than 0
